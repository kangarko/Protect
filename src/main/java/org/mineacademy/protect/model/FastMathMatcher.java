...
public final class FastMathMatcher implements ConfigSerializable {
	...
	public SerializedMap serialize() {
		return SerializedMap.fromArray("mode", this.mode, "limit", this.limit);
	}
	...
	public static FastMathMatcher compile(String input) {
		...
		ValidCore.checkBoolean(parts.length == 2, "Invalid syntax. Expected: <mode> <number> (i.e. '< 3'). Got: " + input);
